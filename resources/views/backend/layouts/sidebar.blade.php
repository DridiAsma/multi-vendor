<div id="left-sidebar" class="sidebar">
    <div class="sidebar-scroll">
        <div class="user-account">
            <img src="{{asset('back/assets/images/user.png')}}" class="rounded-circle user-photo" alt="User Profile Picture">
            <div class="dropdown">
                <span>Welcome,</span>
            ...
            <div class="tab-pane active" id="admin">
                <nav class="sidebar-nav">
                    <ul class="main-menu metismenu">
                        ...
                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-wallet"></i><span>Order Management</span> </a>
                            <ul>
                        ...
                        <li><a href="noticeboard.html"><i class="icon-info"></i>Post Category</a></li>
                        <li><a href="app-taskboard.html"><i class="icon-list"></i>Post Tag</a></li>
                        <li><a href="our-centres.html"><i class="icon-pin"></i>Post Management</a></li>
                        <li><a href="hostel.html"><i class="icon-target"></i>Review Management</a></li>
                        <li><a href="transport.html"><i class="icon-support"></i>Coupon Management</a></li>
                        <li><span>-- Extra</span></li>
                        <li>
                            <a href="#Authentication" class="has-arrow"><i class="icon-lock"></i><span>User Management</span></a>
                            <ul>
                        ...
                        <li><a href="transport.html"><i class="icon-support"></i>Comments Management</a></li>
                        <li><a href="transport.html"><i class="icon-support"></i>Setting</a></li>
                    </ul>
                </nav>
            </div>
