                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="list-unstyled team-info margin-0">
                                                <li><img src="{{asset('back/assets/images/xs/avatar1.jpg')}}" title="Avatar" alt="Avatar"></li>
                                                <li><img src="{{asset('back/assets/images/xs/avatar6.jpg')}}" title="Avatar" alt="Avatar"></li>
                                            </ul>
                                        </td>
                                        <td>$ 356</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="list-unstyled team-info margin-0">
                                                <li><img src="{{asset('back/assets/images/xs/avatar1.jpg')}}" title="Avatar" alt="Avatar"></li>
                                                <li><img src="{{asset('back/assets/images/xs/avatar5.jpg')}}" title="Avatar" alt="Avatar"></li>
                                                <li><img src="{{asset('back/assets/images/xs/avatar9.jpg')}}" title="Avatar" alt="Avatar"></li>
                                            </ul>
                                        </td>
                                        <td>$ 542</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="list-unstyled team-info margin-0">
                                                <li><img src="{{asset('back/assets/images/xs/avatar3.jpg')}}" title="Avatar" alt="Avatar"></li>
