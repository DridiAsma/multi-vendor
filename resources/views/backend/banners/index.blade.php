                                    ...
                                    <tbody>
                                        @foreach ($banners as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('banner.edit', $item->id) }}" data-toggle="tooltip" title="edit" class="float-left btn btn-sm btn-outline-wrning" data-placement="bottom"><i class="fas fa-edit"></i></a>
